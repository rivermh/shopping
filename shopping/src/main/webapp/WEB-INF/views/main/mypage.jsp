			...
			<div class="container px-5">
				...
				<div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
					<div class="text-center mb-5">
						...
						<p class="lead fw-normal text-muted mb-0">마이페이지</p>
					</div>
							...
							<form id="f_joinForm">
								...
								<div class="form-floating mb-3">
									<input class="form-control" id="memberName" name="memberName" type="text"
										value="${memberLogin.memberName}" disabled /> <label
										for="memberName">이름</label>
								</div>

								<!-- Gender -->
								<div class="form-floating mb-3">
									<input class="form-control" id="memberGender"
										name="memberGender" value="${memberLogin.memberGender}" disabled/>				
								...
								<div class="form-floating mb-3">
									<input class="form-control" id="memberBirth" name="memberBirth" type="text"
										value="${memberLogin.memberBirth}" disabled /> <label for="memberBirth">생년월일
										(YYYYMMDD)</label>
								</div>
								...
								<div class="form-floating mb-3">
									<input class="form-control" id="memberEmail" name="memberEmail" type="email"
										value="${memberLogin.memberEmail}" disabled /> <label
										for="memberEmail">이메일</label>
									<button type="button" class="btn btn-outline-secondary mt-2"
										onclick="checkEmail()">이메일 변경하기</button>
								</div>
								...
								<!-- Country -->
								<div class="form-floating mb-3">
									<input class="form-control" id="memberCountry"
										name="memberCountry" value="${memberLogin.memberEmail}" disabled/>
								<label for="memberCountry">나라</label>									
								</div>
