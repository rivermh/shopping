                            ...
                            <c:if test="${empty memberLogin}">
                                <form id="loginForm">
								    ...
								    <div class="form-floating mb-3">
								        <input class="form-control" id="memberEmail" type="text" placeholder="Please Enter Your Email Address" name="memberEmail" />
								        <label for="memberEmail">Email Address</label>
								    </div>
								    
								    <!-- password input-->
								    <div class="form-floating mb-3">
								        <input class="form-control" id="memberPasswd" type="password" placeholder="Please Enter Your Password" name="memberPasswd" />
                                    ...
                                    <!-- Submit Button-->
                                    <div class="d-grid"><button class="btn btn-primary btn-lg" id="loginBtn" type="button">login</button></div>
                                    <!-- Signup Button -->
									<div class="d-grid mt-3">
									    <a class="btn btn-secondary btn-lg" href="/signup">Sign Up</a>
									</div>
                                </form>
                                </c:if>
                            </div>
